...
function App() {
  const {
    ...
    selectedFilter: inputSelectedFilter,
    handleChangeFilters: handleInputChangeFilters
  } = useBestAds();
  ...
  const {
    ...
    selectedFilter: outputSelectedFilter,
    handleChangeFilters: handleOutputChangeFilters
  } = useBestAds();
